  ...
  return (
    ...
    >
      ...
      <div className="flex-grow overflow-hidden">
        ...
        >
          <span className="flex items-center gap-[0.5rem] flex-wrap">
            {chatData.profile.name || chatData.profile.username}
            {chatData.profile.isScam && (
              <span className="text-[0.9rem] px-[0.5rem] py-[0.1rem] bg-danger text-white rounded-md font-bold uppercase">
                SCAM
              </span>
            )}
            {chatData.profile.isVerified && <VerifiedBadge size={16} />}
            {chatData.profile.isBot && (
              <span className="text-[0.9rem] px-[0.5rem] py-[0.1rem] bg-cta-icon text-white rounded-md font-medium">
                BOT
              </span>
            )}
          </span>
          ...
          {!chatMode && (
            <>
              ...
              >
                ...
                {chatData.latestMessage.messageType === "sticker" && (
                  <span className="flex items-center gap-[.5rem]">
                    🎨 Sticker
                  </span>
                )}

                {chatData.latestMessage.messageType === "premiumEmoji" && (
                  <span className="flex items-center gap-[.5rem]">
                    ✨ Premium Emoji
                  </span>
                )}
