...
function NewMessage({ currentChatRoom }) {
  ...
  // Send premium emoji as message
  const handleSendPremiumEmoji = (emoji, pack) => {
    if (!userId || !chatRoomId) return;
  ...
  return (
    <div className="flex flex-col shrink-0">
      ...
      <EmojiModal
        ...
        onSendPremiumEmoji={handleSendPremiumEmoji}
      />
